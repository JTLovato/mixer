const newData = {
    drinks: [
        ...
        },
        {
            ...
            rating: '9',
            description: 'Here’s a unique highball cocktail that we highly recommend giving a try: the Finnish Long Drink! This concoction of gin and usually grapefruit soda was invented in Finland in the 1950’s, and you can find it everywhere in country. It’s now becoming available canned in the US: but why not make it homemade? This spin is easy to make and so fizzy, sweet tart and refreshing, we couldn’t help but take another sip.',
        },
        {
            name: 'French 77',
            id: '45',
        ...
        },
        {
            ...
            rating: '9',
            description: 'Here’s an herbal, sweet tart cocktail that’s a new favorite around here: this Lavender Collins Cocktail! It’s a spin on the classic Tom Collins starring this fresh herb. And wow, is it full of flavor! It’s sweet tart, zing and bubbly, with a subtle floral finish to each sip. It’s got just the right essence of lavender that leaves you wanting more. Alex and I have been making a string of lavender drinks, and this one is at the top of the list. Here’s what to know about making a lavender cocktail.',
        },
        {
        ...
        },
        {
            ...
            rating: '9',
            description: 'Here’s an over-the-top impressive classic cocktail: the Ramos Gin Fizz! The impossibly tall frothy topping and tangy burst of lime, lemon and orange blossom water makes it taste just like a lemon meringue pie. Is the Ramos Gin Fizz better than the classic Gin Fizz? Absolutely. In all honesty, we didn’t think anything could beat the classic. But one sip of this one, and you’ll realize just how special this drink is.',
        },
        {
            name: 'Red Snapper',
            id: '56',
            image: 'red_snapper.jpg',
            ingredients:['tomato juice', 'lemon juice', 'worcestershire sauce', 'horeradish', 'tobasco', 'celery salt', 'gin', 'black pepper', 'old bay seasoning', 'celery', 'lemon wedge', 'olive', 'cocktail onion'],
            ...
            rating: '9',
            description: 'Here’s a tasty spin on a classic: the Red Snapper cocktail! The name doesn’t betray this drink: though it’s both red and snappy. But it’s holding a secret: it’s essentially a classic Bloody Mary with gin. Switching out the vodka leads to a whole new drink: savory, spicy, tangy, spicy, with a hint of botanical on the finish from the gin. It’s a fun variation on the standard: and even more so to surprise your guests with this unique spin.',
        },
        {
            name: 'Pegu Club',
            id: '57',
        ...
        },
        {
            ...
            rating: '9',
            description: 'Here’s an impressive cocktail that’s pretty darn perfect, in our opinion: this Pomegranate Gin Fizz! The Gin Fizz is one of our favorite classic cocktails: sweet tart and refreshing, with a festive egg white foam. Take it over the top with this pomegranate spin: it elevates the sweet tart flavor and gives the drink a brilliant jewel-toned color! Here we used POM Wonderful 100% Pomegranate Juice to make this deliciously festive cocktail. It will impress absolutely everyone (we promise!): for the holidays or in any season.',
        },
        {
            name: 'Salty Dog',
            id: '59',
        ...
        },
        {
            ...
            directions: 'Add all ingredients to a cocktail shaker. Fill it with ice and shake it until cold. Strain the drink into a hurricane or highball glass that’s filled with ice. Top with splash of soda water (about 1 ounce or so). Garnish with a cocktail cherry and orange wedge.',
            rating: '9',
            description: 'Want an impressive cocktail that’s fruity and refreshing? Try the Singapore Sling! This one’s for the adventurous drinker because it calls for a whopping 8 ingredients! It’s the longest ingredient list of any of our cocktail recipes and has a few specialty ingredients. But if you want to experience a classic cocktail and don’t mind the challenge: it’s a must try! The combination of fruity, sweet tart and bubbly is intriguingly complex and just plain fun.',
        },
        {
            name: 'Southside',
            id: '61',
        ...
        },
        {
            ...
            ingredients:['gin', 'simple syrup', 'lemon juice', 'soda water', 'maraschino cherry', 'lemon wedge'],
            directions: 'Add the gin, syrup and lemon juice to a cocktail shaker with 4 ice cubes. Shake well until chilled. Strain the liquid into an ice filled glass, and top off the glass with soda water. Garnish with a lemon wheel and cocktail cherry.',
            rating: '9',
        ...
        },
        {
            ...
            rating: '9',
            description: 'Here’s a twist on the classic cocktail that every adventurous drinker needs to try: the White Negroni! This lighter spin on a Negroni and has a vibrant, clear yellow color that’s unmistakable. And the flavor? Light, a little floral, still bitter, but decidedly more interesting than the classic (in our opinion). It requires a few special ingredients, but they’re absolutely worth adding to your collection. Here’s how to make it!',
        },
        // {
        //     name: '',
        //     id: '67',
